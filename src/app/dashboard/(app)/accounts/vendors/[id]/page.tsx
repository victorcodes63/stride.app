      ...
      <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between mb-6">
        <div className="flex items-start gap-3 min-w-0">
          <div className="rounded-xl bg-primary-50 p-2.5 border border-primary-100">
            <Store className="w-8 h-8 text-primary-800" />
          </div>
          <div className="min-w-0">
            <h1 className="text-2xl font-bold text-primary-900 tracking-tight">{data.name}</h1>
        ...
        <div className="flex flex-wrap gap-2 shrink-0">
          <Link
            ...
            className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-primary-900 text-white text-sm font-semibold hover:bg-primary-800"
          >
