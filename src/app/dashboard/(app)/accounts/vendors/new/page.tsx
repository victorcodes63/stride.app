...
export default function NewVendorPage() {
  ...
  return (
    <div className="w-full min-w-0 max-w-2xl">
      ...
      <h1 className="text-2xl font-bold text-primary-900 tracking-tight flex items-center gap-2 mb-2">
        <Store className="w-7 h-7 text-primary-700" />
        New vendor
      </h1>
      <p className="text-neutral-600 text-sm mb-6">
        Add a supplier or an internal creditor profile (e.g. petty cash). Bills and payments are created from the
        vendor page or the bills list.
      </p>
