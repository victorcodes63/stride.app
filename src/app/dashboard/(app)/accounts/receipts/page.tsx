  ...
  return (
    <div className="w-full min-w-0 max-w-5xl">
      ...
      <div className="flex items-start gap-3 mb-6">
        <Wallet className="w-9 h-9 text-primary-700 shrink-0" />
        <div>
          <h1 className="text-xl sm:text-2xl font-bold text-primary-900 tracking-tight">
            Receipts &amp; allocations
          </h1>
          <p className="text-sm text-neutral-600 mt-1">
            Record money received from billing clients and split it across one or more invoices. Invoice status
            updates from allocated amounts.
          </p>
        </div>
      </div>
      ...
      {canManagePayments && (
        <form
          onSubmit={submit}
          className="mb-10 rounded-2xl border border-neutral-200/90 bg-white p-5 sm:p-6 shadow-sm space-y-5"
        >
            ...
            <table className="w-full min-w-[800px] text-sm">
              <thead>
                <tr className="border-b border-neutral-200 bg-neutral-50/90">
                  <th className="text-left px-4 py-3 font-semibold text-neutral-700">Received</th>
                  ...
                  <th className="text-left px-4 py-3 font-semibold text-neutral-700">Ref / method</th>
                  <th className="text-left px-4 py-3 font-semibold text-neutral-700">Allocations</th>
                </tr>
              </thead>
              <tbody>
                {payments.map((p, index) => (
                  ...
                  >
                    <td className="px-4 py-3 tabular-nums text-neutral-700">{p.receivedAt}</td>
