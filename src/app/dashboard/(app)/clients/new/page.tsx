    ...
    <div className="w-full min-w-0">
      <nav className="mb-4 sm:mb-5" aria-label="Breadcrumb">
        <ol className="flex items-center gap-1.5 text-sm text-neutral-500">
          ...
          <li className="text-primary-900 font-medium" aria-current="page">Add client</li>
        </ol>
      </nav>
      <div className="mb-6 sm:mb-8 w-full min-w-0">
        <h1 className="text-xl sm:text-2xl lg:text-3xl font-bold text-primary-900 mb-1">Add client</h1>
        <p className="text-neutral-600 text-sm sm:text-base w-full">
          Add a company to tie jobs to. You can show the company name on the job board or list jobs as anonymous (Confidential).
        </p>
      </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <label htmlFor="isAnonymous" className="text-sm text-neutral-700">
              ...
              <span className="block mt-0.5 text-neutral-600">
                When checked, the job board will show &quot;Confidential&quot; instead of this company name for jobs tied to this client.
              </span>
            </label>
          </div>
